...
deploy-flp:
	...
	sed 's|%LOKI_URL%|'$$LOKI_URL'|g; s|%EAST_GATEWAY_EXTERNAL_IP%|$(EAST_GATEWAY_EXTERNAL_IP)|g; s|%EAST_GATEWAY_CLUSTER_IP%|$(EAST_GATEWAY_CLUSTER_IP)|g; s|%WEST_GATEWAY_EXTERNAL_IP%|$(WEST_GATEWAY_EXTERNAL_IP)|g; s|%WEST_GATEWAY_CLUSTER_IP%|$(WEST_GATEWAY_CLUSTER_IP)|g;' \
